...
4. Вот эта часть задач в ДЗ заставила задуматься:
   ...
   Качество подбора конфигурации автовакуума - тем выше, чем больший tps мы получаем от субд и чем меньшую дисперсию tps, при выполнении бенчмарка и срабатывании автовакуума, во время бенчмарка.
   ...
   Тогда вариантов два.
   Первый вариант: то что называется "перебор по решётке", или, другое называние - "метод координатного спуска".
