...
5. Кстати выполнил `analyze verbose`, в бд `demo` 
   И посмотрел на план выполнения тех двух запросов, которые упоминал выше.
   ...
   Для запроса с условием `tf.ticket_no = '0005432661915'` как и ожидалось: индексный доступ показывает себя луче.
