...
Из любопытства, чтобы увидеть стоимости выполнения `Q2` при фуллскане heap-ипостаси `ticket_flights` и насколько это выправляет секционирование сделал такое:
