...
Действительно, в плане выполнения этого запроса ([Q11.explain](/HomeWorks/Lesson18/Q11.explain)) есть такой этап:
```
...
7. `Придумайте 3 своих метрики на основе показанных представлений`
    На мой взгляд это слишком обще поставленный вопрос. На него не возможно ответить с какой то конкретикой.
