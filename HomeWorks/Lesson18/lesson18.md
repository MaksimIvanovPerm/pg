...
Рассмотрение работы хеш-джойнов, включение/выключение их где то, или увелчиение `work_mem`, если где то - уместно но не вмещается в память, спиллится в темп-ы, решил оставить на потом.
